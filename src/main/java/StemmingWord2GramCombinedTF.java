 ...
 */
public class StemmingWord2GramCombinedTF extends FeatureSelector {
    public StemmingWord2GramCombinedTF(String trainTextsFolder,
    ...
    public void run() {
        super.run();
        System.out.println("Unfilterd Stemming Word2Gram Combined TF");
        try
        {
...
//
            ...
            EtymonFeatureCorpus etymonFeatureCorpus = EtymonExtractor.extactFeatures(toArffFileCorpus, ValueType.TF);
//
...
//            NGramFeatureCorpus triGramTfidfFeatureCorpus = NgramExtractor.extractFeatures(toArffFileCorpus, NgramType.GRAM_3, ValueType.TF);
            NGramFeatureCorpus word2GramTfidfFeatureCorpus = NgramExtractor.extractFeatures(toArffFileCorpus, NgramType.WORD_2_GRAM, ValueType.TF);
//
